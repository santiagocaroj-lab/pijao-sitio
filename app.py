...
<style>
    ...
    /* Ocultar elementos nativos de Streamlit y quitar paddings que generan espacios negros */
    ...
    .welcome-subtitle {
        ...
        font-weight: 300;
        color: #E2DFDB;
        margin-bottom: 40px; /* Separación extra para el botón */
    ...
    /* Control de Audio Flotante Mejorado y Visible */
